...
Original file is located at
    https://colab.research.google.com/drive/1U35sX5zb4VV8YUSHwx9c553aZFi4AH1G
"""
...
"""## ***Do consumers purchase more avocados in small bags or big bags?***"""
...
"""## ***How have the sizes of small avocados changed in the past four years in the US?***"""

df.groupby('year')['4046'].mean().plot(kind = 'pie', subplots = True)

"""## ***How have the sizes of medium avocados changed in the past four years in the US?***"""

df.groupby('year')['4225'].mean().plot(kind = 'pie', subplots = True)

"""## ***How have the sizes of large avocados changed in the past four years in the US?***"""
